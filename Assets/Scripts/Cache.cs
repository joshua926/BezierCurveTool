...
namespace BezierCurve
{
    public class Cache
    {
        ...
        public Cache(Anchor[] anchors, bool isLoop, int distanceSamplesPerSegment, int framesPerSegment)
        {
            Init(anchors, isLoop, distanceSamplesPerSegment, framesPerSegment);
        }

        public void Init(Anchor[] anchors, bool isLoop, int distanceSamplesPerSegment, int framesPerSegment)
        {
